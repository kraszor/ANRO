...
int main(int argc, char **argv)
{
    ...
    int towerHeight;
    n.getParam("towerHeight", towerHeight);
    ...
    int counter = 0;
    while (ros::ok() && counter < towerHeight){
	do {
	   ...
	   gripperClient.call(gripper);
            ...
            srv.request.z = -26.3947677612 + ((towerHeight-1)*20 - counter*20);
            srv.request.r = -10;
	...
	do {
            ...
            srv.request.z = -25.7663116455 + counter*20;
