...
marker.pose.position.x = coordinates[2]+pos_x+0.095;
marker.pose.position.y = coordinates[1]+pos_y;
marker.pose.position.z = coordinates[0]+pos_z;
...
object_marker.pose.position.x = coordinates[5]+pos_x+0.095;
object_marker.pose.position.y = coordinates[4]+pos_y;
object_marker.pose.position.z = coordinates[3]+pos_z;
